...
Crea un objeto para las clases `numeric`, `integer`, `character` e `logical` y comprueba que `r fontawesome::fa("r-project")` lo hizo correctamente.
...
Dimensiones = c("1d", "2d", "nd")
Homogeneo = c("Atomic vector", "Matrix", "Array")
Heterogeneo = c("List", "Data frame", "")

data.frame(Dimensiones, Homogeneo, Heterogeneo) %>% 
  kableExtra::kbl() %>%
...
- **lenght.out**: O comprimento desejado do vetor de saída. 
